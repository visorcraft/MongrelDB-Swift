...
final class MongrelDBLiveTests: XCTestCase {
    ...
    func testHistoryRetentionRoundTrip() async throws {
        ...
        // earliestRetainedEpoch() may report 0 on a fresh daemon (its contract
        // defines 0 as "no history retained"); just exercise the endpoint here.
        // The GET wire shape and decode path are pinned by HistoryRetentionWireShapeTests.
        _ = try await db.earliestRetainedEpoch()
